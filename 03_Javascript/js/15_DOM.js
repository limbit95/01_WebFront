...
("click", () => {
    ...
    // 또다른 방식
    console.log(test.childNodes[list.length-1].previousSibling);
    ...
    // 3. 첫 번째 자식으로 추가 ( prepend("내용" or 노드 or 요소 * n) )
    list[11].prepend("오늘 ", "점심 ", "뭐먹지?");

    // 4. 이전 / 다음 형제로 추가 ( before / after("내용" or 노드 or 요소) )
    // #test 전 / 후에 내용 추가
    test.before("이전 입니다");
    test.after("이후 입니다");
