...
// #btn2a 클릭 시 arrayTest() 함수 호출
document.querySelector("#btn2a").addEventListener
("click", function() {
    const arr1 = [10, 20, 30];
    ...
    참조란?
    - 객체 지향 언어에서
      배열, 객체 등 object는 값을 여러 개 갖고 있는 자료형인데
...
document.querySelector("#btn2c").addEventListener
("click", function() {
...
document.querySelector("#btn3a").addEventListener
("click", function(){
...
// 화살표 함수 기본 형태
arrowList[0].addEventListener
("click", () => {alert("화살표 함수 기본 형태 연습")});
